			...
			<div class="ic_wrap fr">
				...
				<ul class="news_list">
					<c:forEach items="${pageModel.list}" var="data" varStatus="l">
						<li><a href="${ctx}/SafetyInfo/view.do?id=${data.id}">${data.shijian }</a><span class="date">[
						 	${data.addTime}]
						 	</span></li>
				...
				<div class="record">
					...
					<pg:pager >
						...
						<pg:first>
							<a href="${ctx}/SafetyInfo/getAllView.do?pageModel.currentPageNo=${pageModel.topPageNo}">首页</a>
						</pg:first>
						<pg:prev>
							<a href="${ctx}/SafetyInfo/getAllView.do?pageModel.currentPageNo=${pageModel.previousPageNo}">上一页</a>
						</pg:prev>
						<pg:pages>
						...
						<pg:next>
							<a href="${ctx}/SafetyInfo/getAllView.do?pageModel.currentPageNo=${pageModel.nextPageNo}">下一页</a>
						</pg:next>
						<pg:last>
							<a href="${ctx}/SafetyInfo/getAllView.do?pageModel.currentPageNo=${pageModel.buttomPageNo}">尾页</a>
						</pg:last>
					</pg:pager>
				</div>
			</div>
