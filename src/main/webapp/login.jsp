...
<head>
    <meta charset="UTF-8">
    <title><spring:message code="system_name" />-登陆</title>
...
<div class="main-body">
    <div class="login-main">
        ...
        <form class="layui-form login-bottom" action="${pageContext.request.contextPath}/User/login.do">
            <div class="center">
                <div class="item">
                ...
                <div class="item">
                    ...
                    <input type="password" name="s_1" lay-verify="required"  placeholder="请输入密码" maxlength="20">
            ...
            <div class="tip">
                 <a href="${pageContext.request.contextPath}/register.jsp" class="forget-password">注册用户</a>
            </div>
            <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                <button class="login-btn" lay-submit="" lay-filter="login">立即登录</button><br><br>
                <font
...
<script src="${pageContext.request.contextPath}/common/static/login/lib/jquery-3.4.1/jquery-3.4.1.min.js" charset="utf-8"></script>
